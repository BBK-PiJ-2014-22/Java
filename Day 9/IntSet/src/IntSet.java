...
public interface IntSet {
	...
	void add(int number); //adds a new int to the set; if it is there already, nothing happens.
	
	boolean contains(int number); //returns true if the number is in the set, false otherwise.
